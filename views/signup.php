...
<html lang="en">
  <head>
    ...
    <title>TeachLab - Create Account</title>
      ...
      <div class="col-lg-8 col-md-8 col-sm-12 mx-auto">
        ...
        <div class="card-head mt-4 px-4 text-center mb-2">
         <div class="text-center">
          ...
          <h4 style="font-size:24px;" class="fw-bold mb-3">Create Account </h4>
       ...
       <?php if(isset($_GET['emptyemailfield'])){?>
        ...
        <?php if(isset($_GET['emptyfullname'])){?>
          <p class='bg-danger text-white fw-bold p-1 text-center ' style='font-size:15px;'>Empty fullname field</p>
        <?php }?>
        <?php if(isset($_GET['emptypwdfield'])){?>
        ...
        <?php }?>
        <?php if(isset($_GET['emailistaken'])){?>
          <p class='bg-danger text-white fw-bold p-1 text-center ' style='font-size:15px;'>Sorry , email is already taken.</p>
        <?php }?>
        ...
        <form method="post" action='../include/signup.inc.php'>
          ...
          <div class="form-group p-2">
              ...
              <input type="text" id="fullname" name="fullname" class="form-control" placeholder="Enter Fullname..." autocomplete="false"/>
          </div>
        
          <div id="hideextraformfeild">
