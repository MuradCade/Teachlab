...
<html lang="en">
  <head>
    ...
    <title>TeachLab - Forget Password</title>
      ...
      <div class="col-lg-8 col-md-8 col-sm-12 mx-auto">
        ...
        <div class="card-head mt-4 px-4 text-center mb-2">
         <div class="text-center">
          ...
          <h4 style="font-size:24px;" class="fw-bold mb-3">Forget Password</h4>
          <p class="text-wrap tex-center" style="font-size:16px;line-height:1.6em;font-weight:500;">
          Please enter your email address in the field below,
          and we will send you an email to help you access your account.
          </p>
        </div>
       ...
       <?php if(isset($_GET['emailnotfound'])){?>
        <p class='bg-danger text-white fw-bold p-1 text-center ' style='font-size:15px;'>
            Email not Found , Please Try Another Email.
        </p>
        <?php }?>
       ...
       <?php if(isset($_GET['emailfailed'])){?>
        ...
        <form method="post" action='../include/forgetpwd.inc.php'>
