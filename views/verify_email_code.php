...
//check if there is verification_userid passed to this page 
...
<html lang="en">
  ...
  <body style="background-color:#f2f2f2;">
      ...
      <div class="col-lg-8 col-md-8 col-sm-12 mx-auto">
        ...
        <div class="card-head mt-4 px-4 text-start mb-2">
       ...
       <?php if(isset($_GET['emailsent'])){?>
        ...
        <?php }?>
        <?php if(isset($_GET['wrongverificationfield'])){?>
        <p class='bg-danger text-white fw-bold p-1 text-start ' style='font-size:15px;'>Provided verification code is in correct</p>
        <?php }?>
       
        
        <form method="post" action="../include/verify_byemail_code.inc.php">
    ...
    <p class="text-center mt-1 fw-medium mt-2" style="font-size:14px;font-weight:600 !important;">Go Back To <a href="login.php"> Login Page</a></p>
