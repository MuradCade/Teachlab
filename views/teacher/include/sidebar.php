                ...
                <div class="position-sticky" style='margin-bottom:10px !important;'>
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item dropdown mt-3">
                            <a class="nav-link dropdown-toggle  <?php checkactivesidebar($url,'addnewcourse.php'); checkactivesidebar($url,'viewcourse.php');  echo checkifusersubsscriptionexpired($connection,$_SESSION['userid'],'pro','expire')? 'disabled':''; echo checksubscriptionstatus($connection,$teacherid,'subamount') == '0' ? 'disabled':''; ?> fw-bold" href="#" id="course" data-bs-toggle="dropdown" aria-expanded="false" style='font-size:15px;'>
