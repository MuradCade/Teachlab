                ...
                <div class="position-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item dropdown mt-3">
                            <a class="nav-link dropdown-toggle  <?php checkactivesidebar($url,'addnewcourse.php'); checkactivesidebar($url,'viewcourse.php')?> fw-bold" href="#" id="course" data-bs-toggle="dropdown" aria-expanded="false" style='font-size:15px;'>
                        ...
                        <li class="nav-item dropdown mt-3">
                            <a class="nav-link dropdown-toggle  <?php checkactivesidebar($url,'addnewstudent.php'); checkactivesidebar($url,'viewstudent.php');?> fw-bold" href="#" id="dropdownAnalytics" data-bs-toggle="dropdown" aria-expanded="false" style='font-size:15px;'>
                        ...
                        <li class="nav-item dropdown mt-3">
                            <a class="nav-link dropdown-toggle <?php checkactivesidebar($url,'markattandence.php'); checkactivesidebar($url,'viewattadencemarks.php');?> fw-bold" href="#" id="dropdownAnalytics" data-bs-toggle="dropdown" aria-expanded="false"style='font-size:15px;'>
                        ...
                        <li class="nav-item dropdown mt-3">
                            <a class="nav-link dropdown-toggle <?php checkactivesidebar($url,'createassignmentform.php'); checkactivesidebar($url,'viewassignmentform.php');?>  fw-bold" href="#" style='font-size:15px;'id="dropdownAnalytics" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <!-- <li class="nav-item mt-3">
                            ...
                            <i class="bi bi-book"></i>  Exam Form
                            </a>
                        </li> -->
                        <!-- <li class="nav-item mt-3">
                            <a class="nav-link text-secondary" href="#" style='font-size:15px;'>
                ...
                <div class="position-sticky  mt-2">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownAccount">
                            <li style='font-size:14px;'><a class="dropdown-item  <?php checkactivesidebar($url,'setting.php');?>" href="setting.php">Setting</a></li>
