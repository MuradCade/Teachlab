...
include('slices/updatecoursesecurity.slice.php');
...
if (isset($_GET['courseid']) && !empty($_GET['courseid'])) {
    if (isset($_POST['submit'])) {
        ...
        if (empty($coursename)) {
            ...
            $sql = "update course set coursename = '$coursename' where courseid = '$courseid' and teacherid = '$teacherid'";
            $result = mysqli_query($connection, $sql);
            if ($result) {
                header('location:viewcourse.php?updatesuccess');
                exit();
            } else {
                header('location:viewcourse.php?updatefailed');
                exit();
            }
        }
    }
} else {
    header('location:viewcourse.php?redirect');
    exit();
}
...
<head>
    ...
    <title>TeachLab - Update Course</title>
                ...
                <div class="row">
                    <div class="col-12 col-md-8 col-xl-5 mb-4">
                        <div class="card p-2 rounded" style='border:none !important; background-color:#f8f9fa !important;'>
                            ...
                            <div class="card-body">
                                <?php if (isset($_GET['emptycoursefield'])) { ?>
