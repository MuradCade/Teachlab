...
<head>
    ...
    <title>TeachLab | Single Student  Marks Preview</title>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row mb-4 align-items-center">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <!-- <span class="badge bg-secondary">Preview Type: Marks</span> -->
                                    <!--<span class="badge bg-info text-dark">Section: Secure</span> -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="section-card p-3 mb-4">
                                    <h4 class="mb-3" style='font-size:18px;'><i class="bi bi-bar-chart-fill me-2"></i>Overall Performance</h4>
                                    <div class="row g-3">
                                        <div class="col-md-3">
                        ...
                        <div class="section-card p-4 mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="mb-0" style='font-size:18px;'><i class="bi bi-calendar-check me-2"></i>Attendance</h4>
                            ...
                            <div class="card border-0 bg-light">
                                <div class="card-body">
                                    <h5 class="card-title" style='font-size:18px;'>Absent Dates</h5>
                        ...
                        <div class="section-card p-4 mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="mb-0" style='font-size:18px;'><i class="bi bi-journal-text me-2"></i>Assignments</h4>
                        ...
                        <div class="section-card p-4 mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="mb-0" style='font-size:18px;'><i class="bi bi-question-circle me-2"></i>Quizzes</h4>
                        ...
                        <div class="section-card p-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="mb-0" style='font-size:18px;'><i class="bi bi-file-earmark-text me-2"></i>Exams</h4>
                    ...
                    <div class="card-footer bg-light p-4">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                            <div class="mb-3 mb-md-0">
                                <p class="text-muted mb-0">Report Generated At: April 5, 2025</p>
                            </div>
